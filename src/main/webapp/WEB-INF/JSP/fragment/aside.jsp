...
<div class="visible-xs-block xs-option-container">
	<a class="pull-right" data-toggle="collapse" href="#productCatalog">Product
		catalog <span class="caret"></span>
	</a> <a data-toggle="collapse" href="#findProducts">Find products <span
		class="caret"></span></a>
</div>
<!-- Search form -->
	...
	<div id="findProducts" class="panel panel-success collapse">
		...
		<div class="panel-body">
			...
			<div class="more-options">
				<a data-toggle="collapse" href="search">More filters <span
					class="caret"></span></a>
			</div>
		</div>
		<div id="searchOptions" class="collapse">
			...
			<div class="panel-body categories">
				<label> <input type="checkbox" id="allCategories">
					All
				</label>
			...
			<div class="panel-body producers">
				<label> <input type="checkbox" id="allProducers">
					All
				</label>
				<div class="form-group">
					<div class="checkbox">
...
<div id="productCatalog" class="panel panel-success collapse">
	...
	<div class="list-group">
		<a href="products/ebook" class="list-group-item"> <span class="badge">78</span>
			E-book
		</a> <a href="products/mp3player" class="list-group-item"> <span class="badge">75</span>
			Mp3-player
		</a> <a href="products/notebook" class="list-group-item"> <span class="badge">110</span>
			Notebook
		</a> <a href="products/phone" class="list-group-item"> <span class="badge">113</span>
			Phone
		</a> <a href="products/smartphone" class="list-group-item"> <span class="badge">216</span>
			Smartphone
		</a> <a href="products/smartwatch" class="list-group-item"> <span class="badge">95</span>
			Smartwatch
		</a> <a href="products/tablet" class="list-group-item"> <span class="badge">211</span>
			Tablet
		</a>
	</div>
</div>
